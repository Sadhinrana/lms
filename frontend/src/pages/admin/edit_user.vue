      ...
      <div class="card">
        <ul class="nav nav-tabs nav-tabs-card">
          <li v-if="parseInt(userData.role) === 5" class="nav-item">
            <a :class="{ 'nav-link': true, active: $route.query.edit === undefined }" href="#third" data-toggle="tab">Exam Results</a>
          </li>
		  ...
		  <li class="nav-item">
            <a :class="{ 'nav-link': true, active: $route.query.edit !== undefined }" href="#first" data-toggle="tab">Account</a>
          </li>
        </ul>
        <div class="tab-content card-body">
          <div :class="{ 'tab-pane': true, active: $route.query.edit !== undefined }" id="first">
            <form
            ...
            >
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6 col-md-6">
                  <select id="user-role" class="form-control custom-select" v-model="userData.role" @change="getInstructorListOnCompanyChange">
                    ...
                    <option value="9">Teacher Manager</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group row" v-if="parseInt(userData.role) !== 6 && parseInt(userData.role) !== 7">
                ...
                <div class="col-sm-6 col-md-6">
                  <select
                    ...
                    @change="getInstructorListOnCompanyChange"
                  >
			  ...
			  <div class="form-group row">
                <label for="name" class="col-sm-3 col-form-label form-label">Phone Number</label>
                <div class="col-sm-8">
                  <div class="row">
                    <div class="col-md-6">
                      <input
                      ...
                      >
                      <p
                        v-show="error_messages.phone_number.show"
                      >{{error_messages.first_name.message}}</p>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
        ...
        .then(response => {
          ...
          switch (this.userData.role) {
            ...
            case "chief_auditor":
              ...
              break;
            case "auditor":
              this.userData.role = "7";
              break;
            case "head_teacher":
              this.userData.role = "8";
              break;
    ...
    getInstructorListOnCompanyChange() {
