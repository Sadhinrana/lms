<template>
  <div class="container-fluid page__container">
      ...
      <div class="media flex-wrap align-items-center mb-headings">
		  ...
		  <div class="media-body mb-3 mb-sm-0">
		  <router-link :to="{ name: 'chief_auditor_edit_user',params: {id:user_id}}" class="btn btn-info" style="float: right !important;">Back</router-link>
          </div>
      </div>
                              ...
                              <tr v-for="(question, index) in questions" >
                                ...
                                <td>
									<span v-if="['single_choice_as_image'].includes(question.type)">
											<img :src="question.answer.answer_title" alt="" width="80" class="rounded" v-if="question.answer.answer_title">
									</span>
									<span v-else>
