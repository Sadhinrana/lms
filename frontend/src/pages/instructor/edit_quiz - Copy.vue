                            ...
                            <div class="media align-items-center">
                                ...
                                <div class="media-right text-right">
                                    <div style="width:100px; display:inline-block">
                                        ...
                                        <a href="#" @click.prevent="deleteQuestion(question.id)"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="#">
                            ...
                            <!-- <div class="col-sm-4"> -->
                            <!-- <textarea v-model="ques_data.formula" cols="30" rows="3">{{ques_data.formula}}</textarea> -->
                            <!-- </div> -->
                            <!-- <div class="col-sm-4 katex_question" style="text-align: center;" > -->
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        if (this.ques_data.audio != null) {
                            ...
                            console.log(this.ques_data.audio);
