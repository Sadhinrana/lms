<template>
    <div class="container-fluid page__container">
        ...
        <div class="media flex-wrap align-items-center mb-headings">
            ...
            <div class="media-body mb-3 mb-sm-0">
                <router-link :to="{ name: 'instructor_edit_user',params: {id:user_id}}" class="btn btn-info"
    ...
    export default {
        ...
        methods: {
            ...
            fetchQuestion() {
                ...
                axios
                    .get(this.routes.question.REVIEW_QUEST_OF_QUIZ + "/" + this.$route.params.quiz_id)
                    .then(response => {
                        ...
                        if (response.data.length > 0) {
                            this.reviewPattern(this.get_questions);
                        }
