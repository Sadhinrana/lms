            ...
            <div class="card" id="quiz-container">
                ...
                <div class="col-12">
                    ...
                    <div class="alert alert-dismissible bg-danger text-white border-0 fade"
                         :class="added_error?'show':''" v-if="added_error" v-for="error in added_error_messages.errors"
                         role="alert">
                        ...
                        <li class="list-group-item nestable-item" v-for="(question,index) in questions"
                                ...
                                <div class="media-right text-right">
                                    <div style="width:100px; display:inline-block">
                                        ...
                                        <a v-if="authUser.role !== 'content_manager'" href="#"
                                           @click.prevent="deleteQuestion(question.id)" class="btn btn-warning btn-sm"
                            ...
                            <ul class="nestable-list" v-if="question.child_questions.length > 0">
                                <li class="list-group-item nestable-item"
                                    ...
                                    :data-id="child_question.id" v-if="child_question.parent_id">
                                    <div class="media align-items-center">
                                        <div class="media-left">
                                            <router-link
                    ...
                    <div class="modal-body">
                        <form action="#">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-md-4">
                                    <p>
                                        <img :src="ques_data.image" alt="something wrong in image" width="100"
                                             class="rounded" v-if="ques_data.image">
                                    </p>
                                    <div class="custom-file">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="form-inline" v-if="ques_data.audio">
                                    <span>
									  <a
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select id="type" class="custom-control custom-select form-control"
                                        ...
                                        <option value="single_set">Single SAT</option>
                            ...
                            <div class="form-group row" v-if="!not_add_answers_type.includes(ques_data.type)">
                                <label class="col-form-label form-label col-md-3"
                                       v-show="['single_set'].includes(ques_data.type)">Select Single Sat:</label>
                                <!--<div class="col-md-3">
                            ...
                            <div class="form-group row" v-if="!not_add_answers_type.includes(ques_data.type)">
                                ...
                                <!-- <a class="btn btn-default" @click.prevent="addInputQuestion"><i class="material-icons">add</i> Bind Answer - {{question_index}}</a> -->
                                <!--<div class="col-md-3" v-show="['single_set'].includes(ques_data.type)">
                                    <select id="type" class="custom-control custom-select form-control" @change="onChangeSingleSet($event)">
                                        <option :value="null" readonly>--Select--</option>
                                        <option v-for="get_parent in get_single_set_parent" :value="get_parent.id" >{{get_parent.title}}</option>
                                    </select>
                                </div>-->
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <div :id="'editor2_'+modal_index" class="quill-outer"
                                         v-show="['fill_in_blank', 'drag_drop', 'dropdown'].includes(ques_data.type)">
                                        ...
                                        <tr v-for="(item, index) in answers">
                                            ...
                                            <td>
                                                <input type="file" class="form-control"
                                                       @change="addQuestionImage($event, index)">
                                            </td>
                                            <td>
                            ...
                            <div class="form-group row" v-if="!['parent'].includes(ques_data.type)">
                                ...
                                <div class="col-md-4">
                                    <input id="touch-spin-2" data-toggle="touch-spin" data-min="0" data-max="100"
                                           data-step="5" type="text" v-model="ques_data.score" value="1"
                                           class="form-control"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-3">
                                    <a href="#" class="btn btn-success"
                                       @click.prevent="update_new(ques_data.id)">Save</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    export default {
        ...
        methods: {
            fixValidation() {
                ...
                this.modal_verify = "add_modal";
                $("#editQuiz_" + this.modal_index).modal();
            },

            addQuestionImage(event, index) {
                var file = event.target.files[0];
                var reader = new FileReader();
                reader.readAsBinaryString(file);

                reader.onload = () => {
                    this.answers[index].title = "data:image/jpeg;base64," + btoa(reader.result);
            ...
            onImageAdd(event) {
                ...
                reader.onload = () => {
                    ...
                    this.ques_data.image_update = true;
            ...
            fetchQuestion() {
                ...
                this.$store.dispatch("enableLoading");
                axios
                    .get(this.routes.question.GET_QUEST_OF_QUIZ + "/" + this.$route.params.id)
                    .then(response => {
            ...
            removeAnswer(index, question_type) {
                if (
                    ...
                    question_type == "single_choice_as_image" ||
                    question_type == "math_set" ||
                    question_type == "single_set" ||
                    question_type == "multiple_choice" ||
                    question_type == "sorting_horizontal" ||
                    question_type == "matching" ||
                    question_type == "matching_as_image" ||
                    question_type == "matching_text_image" ||
            ...
            updateQuestion(idquest) {
                ...
                if (this.ques_data.type == "fill_in_blank" || this.ques_data.type == "dropdown" ||
                    ...
                    if (
                        ...
                        if (this.isCheck == 1) {
                            this.isCheck = 0;
                            this.submitUpdateQuestionEditCase(idquest);
                        } else {
            ...
            updateQuestionWithAudio() {
                ...
                form_data.append("video_link", this.ques_data.video_link ? this.ques_data.video_link : '');
            ...
            submitUpdateQuestionEditCase(idquest) {
                if (this.ques_data.type == 'single_set') {
                    this.ques_data.parent_id = this.single_set_parent;
                    console.log(this.ques_data);
                }
                axios
                    .put(this.routes.question.UPDATE_QUESTION + idquest, this.ques_data)
                    .then(response => {
                        if (
                            this.ques_data.type != "fill_in_blank" &&
                            this.ques_data.type != "drag_drop"
            ...
            checkIfHasCorrectAnswer() {
                if (
                    ...
                    this.ques_data.type == "single_set" ||
                    this.ques_data.type == "math_set"
                ) {
            ...
            getQuestionByID(idqes) {
                this.ques_data.image_update = false;
                $("#editQuiz_" + this.modal_index).modal();
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        if (this.ques_data.video_link != null) {
                            this.GUI.SHOW_VIDEO_LINK_INPUT = true;
                            $("#video_link_input").prop("checked", true);
                        }
            ...
            toggleAudioVideo() {
                if (!document.getElementById("video_link_input").checked) {
                    this.ques_data.video_link = null;
                }
                if (!document.getElementById("audio_file_input_edit").checked) {
                    this.ques_data.audio = null;
                }
            },
        },
