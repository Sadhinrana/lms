            ...
            <div class="table-responsive card-body">
                <table class="table table-middle">
                    ...
                    <tr v-for="(essayAnswer, index) in essayAnswers" :key="essayAnswer.id">
                        ...
                        <td><a href="javascript:void(0)" @click="reviewAnswer(index)">Reviews({{ essayAnswer.reviews.length }}) <span v-if="getUnseenReview(index)">({{ getUnseenReview(index) }} unseen)</span></a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="#" @submit.prevent="store">
                            ...
                            <div class="form-group row" v-show="reviews.length && !is_closed">
                                <label class="col-sm-3 col-form-label form-label">Replay:</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row mb-0" v-show="reviews.length && !is_closed">
                                <div class="col">
