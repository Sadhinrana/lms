                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    >
                                        ...
                                        <option v-for="company in company_list.data" :value="company.id">{{ company.name
                                            }}
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <button href="#" class="btn btn-success" @click.prevent="assignCourse">Enroll
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table mb-0">
                            ...
                            <tr v-for="quiz in quiz_data">
                                ...
                                <td class="text-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="#" v-if="quiz.is_block == 2" @click.prevent="blockQuiz(quiz.id,1)"
                                           class="dropdown-item">Lock</a>
                                        <a href="#" v-if="quiz.is_block == 1" @click.prevent="blockQuiz(quiz.id,2)"
                                           class="dropdown-item">Unlock</a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
